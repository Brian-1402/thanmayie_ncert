...
\begin{enumerate}
	\item Define work using both the formula and the sentence definition. \\
		{\itshape
			...
			Sentence definition: Work done,
			\begin{itemize}
				\item[-] by a force 
				\item[-] acting on an object 
				\item[-] is equal to the magnitude of the force multiplied by the distance moved 
				\item[-] in the direction of the force.
			\end{itemize}
		}
	\item Mention the SI unit of work (both standalone unit, and in terms of work's constituents from the formula). \\
		\textit{Ans:  1 Joule, or 1 N m.}
	\item Give the definition of SI unit of work. \\
		\textit{Ans: 
			\begin{itemize}
				\item 1 J is the amount of work done on an object when 
				\item a force of 1 N,
				\item displaces it by 1 m,
				\item along the line of action of the force.
			\end{itemize}
			}
